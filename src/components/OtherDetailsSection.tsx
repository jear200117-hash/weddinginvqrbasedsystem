        ...
        <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="rounded-3xl p-8 h-full">
                ...
                <h3 className="text-2xl md:text-3xl font-parisienne text-slate-blue mb-6">
                  Gift Note
                </h3>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="rounded-3xl p-8 h-full flex flex-col justify-between">
                <div>
                  <div className="mb-6">
                  ...
                  <p className="text-base text-slate-blue/80 leading-relaxed mb-6">
                    Help us capture the love! Please tag your photos and help us document our best day ever!
                  </p>
                </div>
          ...
          >
            <div className="rounded-3xl p-8 max-w-5xl mx-auto">
              ...
              <h3 className="text-3xl md:text-4xl font-parisienne text-slate-blue mb-6">
                QR Code
              </h3>
